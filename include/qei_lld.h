...
/*
    ChibiOS/RT - Copyright (C) 2006,2007,2009,2009,2010,
...
/**
 * @brief   QEID9 driver enable switch.
 * @details If set to @p TRUE the support for QEID9 is included.
 * @note    The default is @p TRUE.
 */
#if !defined(STM32_QEI_USE_TIM9) || defined(__DOXYGEN__)
#define STM32_QEI_USE_TIM9                  FALSE
#endif
...
/**
 * @brief   QEID9 interrupt priority level setting.
 */
#if !defined(STM32_QEI_TIM9_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define STM32_QEI_TIM9_IRQ_PRIORITY         7
#endif
/** @} */
...
#if STM32_QEI_USE_TIM9 &&                                                   \
    !OSAL_IRQ_IS_VALID_PRIORITY(STM32_QEI_TIM9_IRQ_PRIORITY)
...
typedef enum {
  ...
  QEI_MODE_DIRCLOCK1 = 1,            /**< Direction/Clock mode 1 (IN1=DIR). */
  QEI_MODE_DIRCLOCK2 = 2,            /**< Direction/Clock mode 2 (IN2=DIR). */
} qeimode_t;
...
#if STM32_QEI_USE_TIM9 && !defined(__DOXYGEN__)
extern QEIDriver QEID9;
#endif
